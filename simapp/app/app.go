...
func NewChainApp(
	...
	memKeys := storetypes.NewMemoryStoreKeys(capabilitytypes.MemStoreKey, evmtypes.MemStoreKey) // TODO: banktypes.DeferredCacheStoreKey ?
...
func (app *ChainApp) RegisterTendermintService(clientCtx client.Context) {
	...
	ctxProvider := func(i int64) sdk.Context {
		...
		// }
		if err != nil {
			panic(fmt.Sprintf("RegisterTendermintService: failed to create query context for EVM: %v+", err.Error()))
		}
