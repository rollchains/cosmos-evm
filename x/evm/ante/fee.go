...
type EVMFeeCheckDecorator struct {
	...
	maxPriority int64 // set like this instead of in app/antedecorators
}

func NewEVMFeeCheckDecorator(evmKeeper *evmkeeper.Keeper, maxPriority int64) *EVMFeeCheckDecorator {
